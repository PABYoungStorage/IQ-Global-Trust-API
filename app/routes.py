    ...
    try:
        ...
        if request.method == 'POST':
                ...
                if file and allowed_file(file.filename):
                    ...
                    new_dest = current_app.config['UPLOAD_FOLDER'] + "/thumbnail" + "/" + title
        ...
        db.events.insert_one({"title": title,"event":event,"description":desc,"event_image":new_dest})
        ...
        if request.method == 'POST':
                ...
                for img in file:
                    ...
                    if img and allowed_file(img.filename):
                        ...
                        new_image = title + "_" +  filename
                        new_dest = current_app.config['UPLOAD_FOLDER'] + "/gallery" + "/" + title
                        if os.path.exists(new_dest):
...
def gallery_add():
    try:
        ...
        if request.method == 'PATCH':
                ...
                db.gallery.update_one({"title":title},{"$set" : {"images": dbdata["images"] }})
